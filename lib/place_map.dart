...
const LatLng defaultLocation = LatLng(10.848291537746121, 106.7872945721427);
...
class _PlaceMapState extends State<PlaceMap> {
  ...
  void initState() {
    super.initState();
    timer = Timer.periodic(Duration(seconds: 5), (Timer t) => reloadApp());
  }
  void reloadApp() {
    setState(() {
      counter++;
      print("loads app: $counter");
      _getCurrentLocation();
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      _addMarker(_lastMapPosition!.latitude, _lastMapPosition!.longitude);
      print(_lastMapPosition);
    } catch (e) {
      _addMarker(defaultLocation.latitude, defaultLocation.latitude);
    }
  }
  ...
  static Future<BitmapDescriptor> _getPlaceMarkerIcon(
      ...
      switch (category) {
        PlaceCategory.visited => BitmapDescriptor.fromAssetImage(
            ...
            'assets/visited.png'),
        PlaceCategory.toGo => Future.value(BitmapDescriptor.defaultMarker),
      };
        ...
        child: ButtonBar(
          ...
          children: [
            ...
            FilledButton(
              style: FilledButton.styleFrom(
                  backgroundColor:
                      selectedPlaceCategory == PlaceCategory.toGo
                          ? Colors.green[700]
                          : Colors.lightGreen),
              child: const Text(
                'To Go',
              ...
              onPressed: () => onChanged(PlaceCategory.toGo),
            ),
          ],
        ),
      ),
...
Future<LatLng?> getCurrentLocation() async {
  try {
    ...
    print("Fail to get current location: $e");
